   ...
   <header class="header">
    ...
    <div class="overlay" id="Movil-menu">
        ...
        <div class="overlay-content">
            <li><a href="/PaperPlus/?C=Index_Controller&M=Index">Inicio</a></li>
            <li><a href="/PaperPlus/?C=Public_Controller&M=Index">Productos</a></li>
            <li><a href="/PaperPlus/?C=Public_Controller&M=AboutUs">Acerca de Nosotros</a></li>
        </div>
    </div>
    <a href="/PaperPlus/?C=User_Controller&M=IndexView" class="btn"><button>Iniciar Sesión</button></a>
   </header>
