   ...
   <header class="header">
    ...
    <div class="overlay" id="Movil-menu">
        ...
        <div class="overlay-content">
            <li><a href="http://localhost/PaperPlus/?C=Index_Controller&M=IndexAdmin">Inicio</a></li>
            <li><a href="http://localhost/PaperPlus/?C=Prods_Controller&M=Index">Productos</a></li>
            <li><a href="http://localhost/PaperPlus/?C=Provs_Controller&M=Index">Proveedores</a></li>
            <li><a href="http://localhost/PaperPlus/?C=User_Controller&M=Regview">Gestión de Usuarios</a></li>
            <li><a href="http://localhost/PaperPlus/?C=Buys_Controller&M=Index">Gestión de compras</a></li>
        </div>
    </div>
    <a href="http://localhost/PaperPlus/?C=User_Controller&M=CloseSession" class="btn"><button>Cerrar Sesión</button></a>
   </header>
