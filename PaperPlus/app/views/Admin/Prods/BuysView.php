...
<div class="contenidoft">
  <div class="content-RegistroUser">
    ...
    <div class="tabla-compra">
      <form action="http://localhost/PaperPlus/?C=Buys_Controller&M=RegNewBuy" method="post" id="form">
      <div class="datos-com">
        <div class="Pr-datos">
          <div class="Pr">
            <h4>Proveedor</h4>
          ...
          <div class="content-tabla" style="overflow: scroll; ">
            <table class="centered-table">
                ...
                foreach ($consInv as $prods) {
                    echo '<tr>';
                    echo '<td><span>'.$prods->Provedor.'</span></td>';
                    echo '<td><span>'.$prods->IdProd.'</span></td>';
                    echo '<td><span>'.$prods->Producto.'</span></td>';
                    echo '<td><span>'.$prods->Stock.'</span></td>';
                    echo '<td><span>'.$prods->Fecha.'</span></td>';
                    echo '</tr>';
                }
                ?>
                <tbody>
