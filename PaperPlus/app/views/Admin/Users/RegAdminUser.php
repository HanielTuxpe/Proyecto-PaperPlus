...
<div class="content-RegistroUser">
    ...
    <form id="frmlogin" action="/PaperPlus/?C=User_Controller&M=RegNewEmp" method="post">
    ...
    <table class="centered-table">
        ...
        <tbody>
            ...
            while($users = $datos->fetch_object()) {
                echo '<form class="form" action="/PaperPlus/?C=User_Controller&M=EditxDel" method="POST">';
                echo '<tr>';
