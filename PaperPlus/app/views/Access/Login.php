    ...
    <div class="content-inicio">
        ...
        <form action="http://localhost/PaperPlus/?C=User_Controller&M=Login" method="post">
            ...
            <p><a href="http://localhost/PaperPlus/?C=User_Controller&M=RegCliview">¿No tienes una cuenta? Regístrate</a></p>
        </form>
    </div>
